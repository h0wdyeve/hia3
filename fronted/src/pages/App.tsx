...
import Benefits from './BenefitsAirline/Benefits'; // Import the YourComponent component
import Benefits2 from './BenefitsAll/Benefits2_1'; // Import the EditFlight component
import Benefits3_1_1 from './BenefitsDetails/Benefits3_1_1'; // Import the BookingFlight component
